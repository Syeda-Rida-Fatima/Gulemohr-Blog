...
export default function Home() {
  return (
    <div className={styles.container}>
      <Head>
        <title>Gulemohr Blog</title>
        <meta name="description" content="Generated by create next app" />
        <meta name="keywords" content="nextjs, Gulemohr blog, Gulemohr coder" />
      ...
      <main className={styles.main}>
       ...
       <Image className={styles.myImg} src="/homeimg.jfif" width={237} height={158}/>
        ...
        <h1 className={styles.title}>
          <span className='dummy'>&lt;Gulemohr/&gt;</span>
        </h1>
        ...
        <div>
          ...
          <div>
            <h3 className={styles.h3}>How to learn React in 2022?</h3>
            <p className={styles.p}>JavaScript is the language used to design logic for the web</p>
            <button className={styles.btn}>Read More</button>
          </div>
          <div>
            <h3 className={styles.h3}>How to learn Google in 2022?</h3>
